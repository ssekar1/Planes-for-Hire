<?php
	...
	print ("<label><strong><center><font size = \"6\" color = \"#595959\">Check Out Result</font></center></strong><br></label>");
	
	print ("<center><div class = \"checkOutResult\">"); 	
	print ("<font size = \"3\" style = \"float:left\">Client ".$_SESSION['loginId'].", here are the result of your check out</font><br>");
	print ("<font size = \"3\" style = \"float:left\">Departing from ".$_SESSION['depart']."</font><br>");
	...
	print ("<font size = \"3\" style = \"float:left\">Requested aircraft model is ".$_SESSION['model']."</font>");
