<?php
	...
	print ("<label><strong><center><font size = \"6\" color = \"#595959\">Check In Result</font></center></strong><br></label>");
	
	print ("<center><div class = \"checkOutResult\">"); 	
	print ("<font size = \"3\" style = \"float:left\">Client ".$_SESSION['loginId']."</font><br>");
	print ("<font size = \"3\" style = \"float:left\">Aircraft model ".$_SESSION['model']." has been checked in</font><br>");
	
	if ($_SESSION['feeOwe'] > 0)
	{
		print ("<font size = \"3\" style = \"float:left\">However, your check in is ".$_SESSION['diffDays']." late. </font>");
